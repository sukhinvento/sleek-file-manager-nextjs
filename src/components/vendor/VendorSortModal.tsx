...
interface VendorSortModalProps {
  isOpen: boolean;
  onClose: () => void;
  onApplySort: (sortConfig: { field: string; direction: 'asc' | 'desc' }) => void;
}

const VendorSortModalComponent = ({ isOpen, onClose, onApplySort }: VendorSortModalProps) => {
...
export const VendorSortModal = memo(VendorSortModalComponent);

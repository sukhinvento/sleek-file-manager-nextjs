...
interface BillingSortModalProps {
  isOpen: boolean;
  onClose: () => void;
  onApplySort: (sortConfig: { field: string; direction: 'asc' | 'desc' }) => void;
}

const BillingSortModalComponent = ({ isOpen, onClose, onApplySort }: BillingSortModalProps) => {
  ...
  const sortOptions = [
    ...
    { value: 'balanceAmount', label: 'Balance Amount' },
...
export const BillingSortModal = memo(BillingSortModalComponent);

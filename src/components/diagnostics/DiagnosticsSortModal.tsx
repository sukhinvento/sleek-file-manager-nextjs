...
interface DiagnosticsSortModalProps {
  isOpen: boolean;
  onClose: () => void;
  onApplySort: (sortConfig: { field: string; direction: 'asc' | 'desc' }) => void;
}

const DiagnosticsSortModalComponent = ({ isOpen, onClose, onApplySort }: DiagnosticsSortModalProps) => {
  ...
  const sortOptions = [
    ...
    { value: 'sampleCollectionDate', label: 'Sample Collection Date' },
...
export const DiagnosticsSortModal = memo(DiagnosticsSortModalComponent);

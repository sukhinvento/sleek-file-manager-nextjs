...
interface PurchaseOrderSortModalProps {
  isOpen: boolean;
  onClose: () => void;
  onApplySort: (sortConfig: { field: string; direction: 'asc' | 'desc' }) => void;
}

const PurchaseOrderSortModalComponent = ({ isOpen, onClose, onApplySort }: PurchaseOrderSortModalProps) => {
...
export const PurchaseOrderSortModal = memo(PurchaseOrderSortModalComponent);

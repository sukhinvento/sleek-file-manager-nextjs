...
interface SalesOrderSortModalProps {
  isOpen: boolean;
  onClose: () => void;
  onApplySort: (sortConfig: { field: string; direction: 'asc' | 'desc' }) => void;
}

const SalesOrderSortModalComponent = ({ isOpen, onClose, onApplySort }: SalesOrderSortModalProps) => {
...
export const SalesOrderSortModal = memo(SalesOrderSortModalComponent);

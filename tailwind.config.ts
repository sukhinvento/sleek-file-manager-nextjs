  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "status-approved-bg": "hsl(var(--status-approved-bg))",
        "status-delivered": "hsl(var(--status-delivered))",
        "status-delivered-bg": "hsl(var(--status-delivered-bg))",
        "status-cancelled": "hsl(var(--status-cancelled))",
        "status-cancelled-bg": "hsl(var(--status-cancelled-bg))",
        "stock-critical": "hsl(var(--stock-critical))",
        "stock-critical-bg": "hsl(var(--stock-critical-bg))",
